...
export const MOCK_ANALYSES: Analysis[] = [
  {
    ...
    satellite: {
      ...
      geeBeforeUrl:  '/satellite/tirol_2000.jpg',
      geeAfterUrl:   '/satellite/tirol_2025.jpg',
      geeBeforeYear: 2000,
      geeAfterYear:  2025,
      geeLocation:   'Ötztal, Tirol, Austria · Source: Landsat 8 / Sentinel-2 via GEE',
      chartUrls: [
...

  {
    ...
    satellite: {
      ...
      geeBeforeUrl:  '/satellite/montblanc_2000.jpg',
      geeAfterUrl:   '/satellite/montblanc_2025.jpg',
      geeBeforeYear: 2000,
      geeAfterYear:  2025,
      geeLocation:   'Mont Blanc, Haute-Savoie, France · Source: Landsat 8 / Sentinel-2 via GEE',
      chartUrls: [
...

  {
    ...
    satellite: {
      ...
      geeBeforeUrl:  '/satellite/suiza_nieve_1990.jpg',
      geeAfterUrl:   '/satellite/suiza_nieve_2023.jpg',
      geeBeforeYear: 1990,
      geeAfterYear:  2023,
      geeLocation:   'Aletsch Glacier region, Switzerland · Source: Landsat 8 / Sentinel-2 via GEE',
      chartUrls: [
        '/charts/switzerland/01_tendencia_anual.png',
        '/charts/switzerland/02_cambio_inicio_vs_final.png',
        '/charts/switzerland/03_promedio_por_decada.png',
...

  {
    ...
    satellite: {
      ...
      geeBeforeUrl:  '/satellite/triftsee_1990.jpg',
      geeAfterUrl:   '/satellite/triftsee_2025.jpg',
      geeBeforeYear: 1990,
      geeAfterYear:  2025,
...
The source "arctic-truth.net" does not appear in the IFCN (International Fact-Checking Network) verified media index, nor in Semantic Scholar or CrossRef databases. Its domain was registered in 2024.`,
  ...
  // r/climate post on selective snow coverage (Switzerland, record winter)
  {
    ...
    satellite: {
      ...
      geeBeforeUrl:  '/satellite/suiza_nieve_cyan_2019.jpg',
      geeAfterUrl:   '/satellite/suiza_nieve_cyan_2023.jpg',
      geeBeforeYear: 2024,
      geeAfterYear:  2025,
...
Regarding the claim that "official data do not reflect field reality": GLAMOS data are precisely field measurements taken by Swiss glaciologists who physically traverse glaciers each autumn since 1879. An observation from a ski slope in December cannot substitute for 45 years of systematic monitoring.`,
  ...
  // ── CASE PROTOTYPE 7: Social Post (X/Twitter) — False ────────────────────
  {
    ...
    satellite: {
      ...
      geeBeforeUrl:  '/satellite/lago_pasterze_1990.jpg',
      geeAfterUrl:   '/satellite/lago_pasterze_2025.jpg',
      geeBeforeYear: 1990,
      geeAfterYear:  2025,
